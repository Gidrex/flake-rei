...
vim.opt.langmap = "АA,БB,ВV,ГG,ДD,ЕE,ЁYo,ЖZh,ЗZ,ИI,ЙY,КK,ЛL,МM,НN,ОO,ПP,РR,СS,ТT,УU,ФF,ХKh,ЦTs,ЧCh,ШSh,ЩShch,Ъ\",ЫY,Ь\',ЭE,ЮYu,ЯYa"
...
-- [[ LSP Diagnostics ]]
local signs = { Error = " ", Warn = " ", Hint = "󰮥 ", Info = " " }
