...
//const vec4 TRAIL_COLOR_ACCENT = vec4(0.776, 0.627, 0.965, 1.0);

//const vec4 TRAIL_COLOR = vec4(0.792, 0.827, 0.961, 1.0); // text
//const vec4 TRAIL_COLOR_ACCENT = vec4(0.651, 0.855, 0.584, 1.0); // green

//const vec4 TRAIL_COLOR = vec4(0.569, 0.843, 0.89, 1.0); // sky
//const vec4 TRAIL_COLOR_ACCENT = vec4(0.569, 0.843, 0.89, 1.0); // sky
